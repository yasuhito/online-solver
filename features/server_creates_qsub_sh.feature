Feature: server creates qsub.sh
  ...
  Scenarios: sdpa solver (ncpu = 1)
    ...
    | sdpa   | 1    | /home/online/solver/sdpa -ds /home/online/tmp/input -o /home/online/tmp/output -p /home/online/tmp/parameter |
  ...
  Scenarios: sdpa solver (ncpu = 4)
    ...
    | sdpa   | 4    | /home/online/solver/sdpa -ds /home/online/tmp/input -o /home/online/tmp/output -p /home/online/tmp/parameter |
  ...
  Scenarios: sdpa_ec2 solver
    ...
    | sdpa_ec2 | nil  | /home/online/solver/sdpa_ec2 -ds /home/online/tmp/input -o /home/online/tmp/output -p /home/online/tmp/parameter |
  ...
  Scenarios: sdpa_gmp solver
    ...
    | sdpa_gmp | nil  | /home/online/solver/sdpa_gmp -ds /home/online/tmp/input -o /home/online/tmp/output -p /home/online/tmp/parameter |
  ...
  Scenarios: sdpara solver (ncpus = 1)
    ...
    | sdpara | 1    | #PBS -q sdpa                                                                                                                |
    | sdpara | 1    | mpiexec -n 1 /home/online/solver/sdpara -ds /home/online/tmp/input -o /home/online/tmp/output -p /home/online/tmp/parameter |
  ...
  Scenarios: sdpara solver (ncpus = 2)
    ...
    | sdpara | 2    | #PBS -q sdpa                                                                                                                |
    | sdpara | 2    | mpiexec -n 2 /home/online/solver/sdpara -ds /home/online/tmp/input -o /home/online/tmp/output -p /home/online/tmp/parameter |
  ...
  Scenarios: sdpara solver (ncpus = 4)
    ...
    | sdpara | 4    | #PBS -q sdpa                                                                                                                |
    | sdpara | 4    | mpiexec -n 4 /home/online/solver/sdpara -ds /home/online/tmp/input -o /home/online/tmp/output -p /home/online/tmp/parameter |
  ...
  Scenarios: sdpara solver (ncpus = 8)
    ...
    | sdpara | 8    | #PBS -q sdpa                                                                                                                |
    | sdpara | 8    | mpiexec -n 8 /home/online/solver/sdpara -ds /home/online/tmp/input -o /home/online/tmp/output -p /home/online/tmp/parameter |
  ...
  Scenarios: sdpara solver (ncpus = 16)
    ...
    | sdpara | 16    | mpiexec -n 16 /home/online/solver/sdpara -ds /home/online/tmp/input -o /home/online/tmp/output -p /home/online/tmp/parameter |
  ...
  Scenarios: sdpara solver (ncpus = 32)
    ...
    | sdpara | 32    | mpiexec -n 32 /home/online/solver/sdpara -ds /home/online/tmp/input -o /home/online/tmp/output -p /home/online/tmp/parameter |
